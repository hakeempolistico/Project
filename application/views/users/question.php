	...
	<div class="w3-twothird">
		...
		<div id="container" style="margin-top:205px">
			<?php foreach($q as $question){?>
			 ...
			 <h1>
			 	<font color = "black" face = "Century Gothic"> <?php echo $question->email; ?>  &nbsp; </font>
			 </h1>
			...
			<div id="body">
				...
				<form method = "POST" action ="/users/reset">
					<font face = "Calibri" color = "black" size = "3">
						  ...
						  <input class="form-control" type="text" name = "forgot_question" placeholder="Forgot Password Question is : "	 value="<?php echo $question->forgot_question; ?>" required disabled>
						</div>
			...
			<a href="/users/reset"><input style = "margin-bottom: 15px;" type = "Submit" value = "Submit"/></a>
					</font>
				</form>
				<?php } ?>				
